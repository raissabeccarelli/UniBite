...
public class PiattiRecord extends UpdatableRecordImpl<PiattiRecord> implements Record8<String, String, String, String, Integer, BigDecimal, Integer, String> {
    ...
    @Override
    public Row8<String, String, String, String, Integer, BigDecimal, Integer, String> valuesRow() {
    ...
    @Override
    public PiattiRecord value7(Integer value) {
        setNumeroporzioni(value);
        return this;
    }

    @Override
    public PiattiRecord value8(String value) {
        setImmagine(value);
        return this;
    }

    @Override
    public PiattiRecord values(String value1, String value2, String value3, String value4, Integer value5, BigDecimal value6, Integer value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PiattiRecord(String nome, String descrizione, String ingredienti, String allergeni, Integer tipoportata, BigDecimal prezzounitario, Integer numeroporzioni, String immagine) {
        super(Piatti.PIATTI);
